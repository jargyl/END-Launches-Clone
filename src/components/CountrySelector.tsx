      ...
      <div className="relative">
        ...
        >
          <Image
            ...
            height={12}
          />
          <p className="font-bold">{selectedCountry.currencies[0].code}</p>
        ...
        >
          <div className="flex justify-center items-center">
            <h1 className="p-5 font-bold text-[14px]">SHIPPING COUNTRY</h1>
          </div>
          <div className="bg-gray-100 border-[1px] border-gray-200 p-5">
            <p className="mb-5">
              You are currently shipping to{" "}
              <span className="font-bold">{selectedCountry.name}</span> and your
